...
describe('FollowUpDialog', () => {
  ...
  it('should show next question when Skip is clicked', async () => {
  ...
  it('should show next question when Next is clicked with an answer', async () => {
    const user = userEvent.setup()
    renderDialog()
  ...
  it('should show Save Entry button after all questions are answered or skipped', async () => {
    const user = userEvent.setup()
    renderDialog()
  ...
  it("should show Save Entry button when I'm done is clicked", async () => {
    const user = userEvent.setup()
    renderDialog()
  ...
  it('should call onSave with only answered followups when Save Entry is clicked', async () => {
    const user = userEvent.setup()
    renderDialog()
